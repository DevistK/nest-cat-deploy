...
CatsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [cats_service_1.CatsService, cat_repository_1.CatsRepository, aws_service_1.AwsService],
        exports: [cats_service_1.CatsService, cat_repository_1.CatsRepository],
    })
], CatsModule);
